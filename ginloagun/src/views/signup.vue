<template>
  <v-container fluid class="main" id="Signup">
    <v-row justify="center" align="center">
      <v-form class="cardTitle" height="140px" width="350px">
        <v-img
        ...
        <div class="mainbg">
          <v-row>
            ...
            <v-col class="logoTitle" cols="6">
                ...
                <div>
                    <v-img max-width="500" :src='account.pic' lazy-src='../assets/user 1.svg'> </v-img>
                </div>
                </v-card>
            </v-col>
            <br />
    ...
    <!-- Dialog -->
    <v-dialog v-model="$store.getters.getDialogState" width="500" persistent>
      <v-card>
        ...
        <v-card-actions>
          ...
          <v-btn
            color="primary"
            @click="$store.dispatch({ type: 'dialog', state: false, msg: '' })"
          >
            ok
          </v-btn>
        </v-card-actions>
  ...
  methods: {
    ...
    submitRegister() {
      ...
      if (state) {
        ...
        console.log("check", this.account.pic);
        this.$store.dispatch({
          type: "register",
